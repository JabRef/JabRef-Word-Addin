import CSL, { Citation, CitationKind, CitationResult, Engine, GeneratedBibliography, MetaData, RebuildProcessorStateData, StatefulCitation } from "citeproc";
...
let referenceData: Array<MetaData>; // User citation data
